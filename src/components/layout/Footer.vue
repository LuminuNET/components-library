		...
		<div class="main-content">
			<div class="container grid">
				...
				<div class="card">
					...
					<ul>
						<li>
							<a target="_blank" href="https://luminu.net/misc/contact/">{{ $t('footer.contactUs') }}</a>
						</li>
						<li>
							<a
								target="_blank"
			...
			C97.7,293.1,124.7,301.6,153.6,301.6"
						...
						<a href="https://discordapp.com/invite/va4nPtV" target="_blank" rel="noopener noreferrer">
							<svg
								class="social-media__icon"
								id="Layer_1"
								xmlns="http://www.w3.org/2000/svg"
